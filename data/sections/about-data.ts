export const aboutData = {
  ...
  whoWeAre: {
    title: "Who we are",
    description: "We have a pool of extraordinary talent for each field, qualified individuals with hardworking mentality. Nova Solutions has some of the best prospects Sri Lanka has to offer.",
    points: [
  ...
  whyChooseUs: {
    ...
    reasons: [
      ...
      },
      {
        ...
        description: "We guarantee you, when you're working with us you're getting the best standard of service in the industry. Our products and services are bound to make you satisfied. You will get the top of the line up to date products with a quality guarantee."
      }
    ]
  }
}; 